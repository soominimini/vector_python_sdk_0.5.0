...
class AnimationComponent(util.Component):
    ...
    async def play_animation_trigger(self, anim_trigger: str, loop_count: int = 1, use_lift_safe: bool = False,
                                     ignore_body_track: bool = False, ignore_head_track: bool = False,
                                     ignore_lift_track: bool = False):  # START
